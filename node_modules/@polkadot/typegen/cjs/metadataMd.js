...
const static_kusama_1 = tslib_1.__importStar(require("@polkadot/types-support/metadata/static-kusama"));
const static_polkadot_1 = tslib_1.__importStar(require("@polkadot/types-support/metadata/static-polkadot"));
...
const ALL_STATIC = {
    kusama: {
        meta: static_kusama_1.default,
        rpc: static_kusama_1.rpc,
        ver: static_kusama_1.version
    },
    polkadot: {
        meta: static_polkadot_1.default,
        rpc: static_polkadot_1.rpc,
        ver: static_polkadot_1.version
    },
    substrate: {
        meta: static_substrate_1.default
    }
};
/** @internal */
...
async function mainPromise() {
    const { chain, endpoint } = (0, yargs_1.default)((0, helpers_1.hideBin)(node_process_1.default.argv)).strict().options({
        chain: {
    ...
    if (endpoint) {
        if (endpoint.startsWith('wss://') || endpoint.startsWith('ws://')) {
            metaHex = await (0, index_js_1.getMetadataViaWs)(endpoint);
        ...
        metaHex = static_substrate_1.default;
    }
    const registry = new types_1.TypeRegistry();
    const metadata = new types_1.Metadata(registry, metaHex);
